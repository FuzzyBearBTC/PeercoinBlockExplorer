...
So I was thinking there are a lot of statistics that are currently not readily available for Peercoin and I feel we can make this blockchain explorer great by adding some of them.
...
So far I have started on the ratio part specifically the POW:POS last 24h. This is all sudo code at the moment.
	...
	Overview:
	Get the last 180 blocks //because the current block time is an average of 8 minutes (when I checked) 60 minutes * 24 hours = 1440. 1440/8 = 180. Could make this dynamic.
	Check flags
